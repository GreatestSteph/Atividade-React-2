        ...
        <div style={estiloFormulario}>
            ...
            <Row className="mb-3">
                <Form.Group as={Col} md="3" controlId="campo1">
                    ...
                    <Form.Control type="text" placeholder="Nome Completo" required value={funcionario.Nome_func}/>
                ...
                <Form.Group as={Col} md="3" controlId="campo2">
                    ...
                    <Form.Control type="date" placeholder="Data de Nascimento" required value={funcionario.Data_nas_func}/>
                ...
                <Form.Group as={Col} md="3" controlId="campo3">
                    ...
                    <Form.Control as="select" required value={funcionario.Genero_func}>
                ...
                <Form.Group as={Col} md="3" controlId="campo4">
                    ...
                    <Form.Control as="select" required value={funcionario.EstadoCivil_func}>
                        <option value="">Selecione...</option>
                ...
                <Form.Group as={Col} md="3" controlId="campo6">
                    ...
                    <Form.Control type="text" placeholder="RG" required value={funcionario.RG_func}/>
                ...
                <Form.Group as={Col} md="3" controlId="campo7">
                    ...
                    <Form.Control type="text" placeholder="CEP" required value={funcionario.CEP_func}/>
                ...
                <Form.Group as={Col} md="3" controlId="campo8">
                    ...
                    <Form.Control type="tel" placeholder="Telefone" required value={funcionario.Telefone_func}/>
                ...
                <Form.Group as={Col} md="3" controlId="campo9">
                    ...
                    <Form.Control type="email" placeholder="Email" required value={funcionario.Email_func}/>
                ...
                <Form.Group as={Col} md="3" controlId="campo10">
                    ...
                    <Form.Control type="text" placeholder="Cargo" required value={funcionario.Cargo_func}/>
                ...
                <Form.Group as={Col} md="3" controlId="campo11">
                    ...
                    <Form.Control type="text" placeholder="Salário" required value={funcionario.Salario_func}/>
                ...
                <Form.Group as={Col} md="3" controlId="campo12">
                    ...
                    <Form.Control type="text" placeholder="Benefícios" required value={funcionario.Beneficios_func}/>
                ...
                <Form.Group as={Col} md="3" controlId="campo13">
                    ...
                    <Form.Control as="select" required value={funcionario.Escolaridade_func}>
                        <option value="">Selecione...</option>
